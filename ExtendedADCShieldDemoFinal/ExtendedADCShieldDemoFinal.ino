...
void setup() {
  ...
  //Analog output pin initialization for sample bias control
  pinMode(6,OUTPUT);
}
...
void loop() {
  ...
  ch1 =  extendedADCShield.analogReadConfigNext(0, SINGLE_ENDED, UNIPOLAR, RANGE5V);
  ...
  //ch7m6 =  extendedADCShield.analogReadConfigNext(0, SINGLE_ENDED, UNIPOLAR, RANGE5V);
